          ...
          <div class="card-body d-flex justify-content-between align-items-center">
            <div>
              <h5 class="card-title text-dark">
                <strong>Dari :  {{ $item->unit_name }}</strong>
            ...
            <div style="margin-left: auto;">
              <form action="{{ route('send.wa', $item->id) }}" method="GET" style="display:inline;">
                <button type="submit" class="btn btn-sm btn-custom me-2" style="background-color: #3A5A80; color: white;">Teruskan</button>
            </form>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th class="col-md-1 text-center">Nama Petugas</th>
                            <!-- <th class="col-md-2 text-center">NIM</th>
                            <th class="col-md-2 text-center">Nomor UPT</th> -->
                            <th class="col-md-2 text-center">Nomor Pelapor</th>
                    ...
                    <tbody>
                        <tr class="text-center">
                            ...
                            <td class="col-md-1 text-center">{{ $item->reviewer_name }}</td>
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <select id="filterUnit" class="form-select">
              ...
              @foreach ($pesan_masuk_upt->pluck('unit_name')->unique() as $unit)
