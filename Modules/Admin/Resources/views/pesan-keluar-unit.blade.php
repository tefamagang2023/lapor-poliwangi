          ...
          <div class="card-body d-flex justify-content-between align-items-center">
            <div>
              <h5 class="card-title text-dark">
                ...
                <small class="text-muted" data-tanggal="{{ \Carbon\Carbon::parse($item->processed_at)->format('H:i:s || d-m-Y') }}">{{ \Carbon\Carbon::parse($item->processed_at)->format('H:i:s || d-m-Y') }}</small>
              </h5>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr class="text-center">
                            ...
                            <td class="col-md-1 text-center">{{ \Carbon\Carbon::parse($item->processed_at)->format('d-m-Y') }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
