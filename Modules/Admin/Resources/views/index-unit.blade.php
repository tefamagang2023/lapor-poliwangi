            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="#" onclick="showEditModal('{{ $item->id }}', '{{ $item->nama }}', '{{ $item->nomor }}')" 
                        class="btn btn-warning btn-sm mx-2">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="#" onclick="showConfirmModal('{{ route('hapus_unit', $item->id) }}', '{{ $item->nama }}', '{{ $item->nomor }}')" 
...
<script>
    ...
    function showEditModal(id, nama, nomor) {
        $('#edit_id').val(id);
        $('#edit_nama').val(nama);
