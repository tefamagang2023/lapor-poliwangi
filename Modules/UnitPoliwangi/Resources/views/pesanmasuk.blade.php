...
<div class="container mt-4">
        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <form action="{{ route('balasPesan', $item->id) }}" method="GET" style="display:inline;">
                <button  type="submit" class="btn btn-sm btn-custom me-2" style="background-color: #3A5A80; color: white;">Balas</button>
            </form>
